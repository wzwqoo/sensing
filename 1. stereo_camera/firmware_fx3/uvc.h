...
#define SENSOR_RESET_GPIO 	22 /* GPIO 22 on FX3 is used to reset the Image sensor. */
...
#define MIN_MODE0_BIT_RATE							(unsigned long)(UVC_MODE0_WIDTH*UVC_MODE0_HEIGHT*8*UVC_MODE0_FPS) //mono8
#define MAX_MODE0_BIT_RATE							(unsigned long)(UVC_MODE0_WIDTH*UVC_MODE0_HEIGHT*8*UVC_MODE0_FPS)
#define MAX_MODE0_FRAME_SIZE						(unsigned long)(UVC_MODE0_WIDTH*UVC_MODE0_HEIGHT*1)//mono8
#define INTERVAL_MODE0								(unsigned long)(10000000/UVC_MODE0_FPS)

#define INTERVAL_30									(unsigned long)(10000000/30)
#define MAX_FRAME_SIZE                              (unsigned long)(UVC_MODE0_WIDTH*UVC_MODE0_HEIGHT*1)
