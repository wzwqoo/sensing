...
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ADAR_fault_Pin);
  /* USER CODE BEGIN EXTI3_IRQn 1 */
  ADAR7251_Emergency_Shutdown();
...
void DCMI_PSSI_IRQHandler(void)
{
  ...
  if (hpssi.ErrorCode == HAL_PSSI_ERROR_OVER_RUN) {
    // RADAR FAULT: The CPU or DMA is too slow!
    // Stop everything, clear FIFO, and restart.
    printf("Bus Overrun! Radar data lost.\n");
  }
